    ...
    ! function(e, s) {
        ...
        return i = function() {
            ...
            return t.prototype._constructor = t, t.prototype.state = function(t, e) {
                ...
                return "undefined" == typeof t ? this.options.animate : (t = !!t, this.options.animate = t, this.$wrapper[t ? "addClass" : "removeClass"]("" + this.options.baseClass + "-animate"), this.$element)
                ...
                return "undefined" == typeof t ? this.options.disabled : (t = !!t, this.options.disabled = t, this.$element.prop("disabled", t), this.$wrapper[t ? "addClass" : "removeClass"]("" + this.options.baseClass + "-disabled"), this.$element)
                ...
                return "undefined" == typeof t ? this.options.readonly : (t = !!t, this.options.readonly = t, this.$element.prop("readonly", t), this.$wrapper[t ? "addClass" : "removeClass"]("" + this.options.baseClass + "-readonly"), this.$element)
                ...
                return "undefined" == typeof t ? this.options.indeterminate : (t = !!t, this.options.indeterminate = t, this.$element.prop("indeterminate", t), this.$wrapper[t ? "addClass" : "removeClass"]("" + this.options.baseClass + "-indeterminate"), this._containerPosition(), this.$element)
                ...
                var e, s;
                return "undefined" == typeof t ? this.options.inverse : (t = !!t, this.$wrapper[t ? "addClass" : "removeClass"]("" + this.options.baseClass + "-inverse"), s = this.$on.clone(!0), e = this.$off.clone(!0), this.$on.replaceWith(e), this.$off.replaceWith(s), this.$on = e, this.$off = s, this.options.inverse = t, this.$element)
                ...
                return null == t && (t = this.options.state), this.$container.css("margin-left", function(e) {
                    return function() {
                        var s;
                        return s = [0, "-" + e._handleWidth + "px"], e.options.indeterminate ? "-" + e._handleWidth / 2 + "px" : t ? e.options.inverse ? s[1] : s[0] : e.options.inverse ? s[0] : s[1]
                    }
                }(this)), s ? e.support.transition ? this.$container.one("bsTransitionEnd", s).emulateTransitionEnd(500) : s() : void 0
            }, t.prototype._elementHandlers = function() {
                return this.$element.on({
                    "change.bootstrapSwitch": function(t) {
                        return function(s, i) {
                            var o;
                            return s.preventDefault(), s.stopImmediatePropagation(), o = t.$element.is(":checked"), t._containerPosition(o), o !== t.options.state ? (t.options.state = o, t.$wrapper.toggleClass("" + t.options.baseClass + "-off").toggleClass("" + t.options.baseClass + "-on"), i ? void 0 : (t.$element.is(":radio") && e("[name='" + t.$element.attr("name") + "']").not(t.$element).prop("checked", !1).trigger("change.bootstrapSwitch", !0), t.$element.trigger("switchChange.bootstrapSwitch", [o]))) : void 0
                        }
                    }(this),
                ...
                return this.$label.on({
                    ...
                    "mousemove.bootstrapSwitch touchmove.bootstrapSwitch": function(t) {
                        return function(e) {
                            var s;
                            if (null != t._dragStart && (e.preventDefault(), s = (e.pageX || e.originalEvent.touches[0].pageX) - t._dragStart, !(s < -t._handleWidth || s > 0))) return t._dragEnd = s, t.$container.css("margin-left", "" + t._dragEnd + "px")
                        }
                    }(this),
                    "mouseup.bootstrapSwitch touchend.bootstrapSwitch": function(t) {
                        return function(e) {
                            var s;
                            if (t._dragStart) return e.preventDefault(), t.options.animate && t.$wrapper.addClass("" + t.options.baseClass + "-animate"), t._dragEnd ? (s = t._dragEnd > -(t._handleWidth / 2), t._dragEnd = !1, t.state(t.options.inverse ? !s : s)) : t.state(!t.options.state), t._dragStart = !1
                        }
                    }(this),
                ...
                return t = this.$element.closest("label"), t.on("click", function(e) {
                    return function(s) {
                        return s.preventDefault(), s.stopImmediatePropagation(), s.target === t[0] ? e.toggleState() : void 0
                    }
                }(this))
                ...
                for (i = [], o = 0, n = t.length; n > o; o++) s = t[o], i.push("" + this.options.baseClass + "-" + s);
                return i
            }, t
        }(), e.fn.bootstrapSwitch = function() {
            var s, o, n;
            return o = arguments[0], s = 2 <= arguments.length ? t.call(arguments, 1) : [], n = this, this.each(function() {
                var t, a;
                return t = e(this), a = t.data("bootstrap-switch"), a || t.data("bootstrap-switch", a = new i(this, o)), "string" == typeof o ? n = a[o].apply(a, s) : void 0
            }), n
